...
def cli():
    ...
    parser.add_argument("-m", "--max-attempts", type=int, required=False, default=4)
    parser.add_argument("-i", "--iterations", type=int, required=False, default=4)
