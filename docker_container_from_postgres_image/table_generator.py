...
class TableGenerator:
    ...
    def init_llama(self):
        self.llm = Llama(
            #model_path="llm-models/llama2/llama-2-7b-chat/ggml-model-q8.gguf",
            #model_path="llm-models/llama2/llama-2-7b-chat/ggml-model-f16.gguf",
            model_path="llm-models/llama2/llama-2-13b-chat/ggml-model-q8_0.gguf",
            #model_path="llm-models/codellama/CodeLlama-13b-Instruct/codellama-13b-ggml-model-f16.gguf",
            #chat_format="llama-2",
            n_gpu_layers=0, # 23 layers => 14662MiB allocated,
            n_ctx=2048,
            # random seed
            seed=int(time()),
